...
/**
 * Registers all mock API middleware on the given Connect/Vite server instance.
 * Shared between configureServer (dev) and configurePreviewServer (preview) to
 * eliminate code duplication.
 */
function registerMockMiddleware(server) {
  ...
  // GET /state - Read current stored state

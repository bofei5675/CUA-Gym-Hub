  ...
  return (
    <div className="pt-16 min-h-screen bg-white flex flex-col items-center justify-center text-center px-4">
      <div className="w-24 h-24 rounded-full bg-gray-100 flex items-center justify-center mb-6">
        <svg height="40" width="40" viewBox="0 0 24 24" aria-hidden="true" className="text-pinterest-red" fill="currentColor">
      ...
      <Link
        to="/"
        className="px-6 py-3 bg-pinterest-red text-white rounded-full font-bold hover:bg-pinterest-hover transition-colors"
      >
        Go back home
      </Link>
    </div>

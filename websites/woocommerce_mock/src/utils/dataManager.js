...
export function createInitialData() {
  ...
  const notifications = [
    ...
    { id: 'notif_4', type: 'info', title: 'WooCommerce tip', content: 'Enable product reviews to build social proof and increase conversions.', dateCreated: daysAgo(3), isRead: true, actions: [] },

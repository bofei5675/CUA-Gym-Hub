...
export function createInitialData() {
  ...
  const issues = [
    ...
    { id: 'i15', projectId: 'p1', iid: 15, title: 'Set up CI/CD pipeline', description: 'Configure GitLab CI with build, test, and deploy stages.', state: 'closed', authorId: 'u4', authorName: 'James Rodriguez', authorEmail: 'james@acme-corp.io', assigneeIds: ['u4'], labelIds: ['l9'], milestoneId: 'm3', dueDate: null, weight: 5, createdAt: '2025-10-20T14:00:00Z', updatedAt: '2025-11-05T10:00:00Z', commentCount: 4 },
  ];
  ...
  const jobs = [
    { id: 'j1', pipelineId: 'pipe1', projectId: 'p1', name: 'build:webpack', stage: 'build', status: 'passed', duration: 45, startedAt: '2026-04-09T10:01:00Z', finishedAt: '2026-04-09T10:01:45Z', runner: 'gitlab-runner-01', logExcerpt: `$ npm ci\nadded 1247 packages in 12.3s\n$ npm run build\n> web-platform@2.0.0 build\n> tsc && vite build\nvite v5.0.0 building for production...\n✓ 1842 modules transformed.\ndist/index.html                  0.46 kB\ndist/assets/index-DiwrgTda.css  31.20 kB\ndist/assets/index-C8Kp52q5.js  245.82 kB\n✓ built in 8.45s\nJob succeeded` },
    { id: 'j2', pipelineId: 'pipe1', projectId: 'p1', name: 'test:unit', stage: 'test', status: 'passed', duration: 67, startedAt: '2026-04-09T10:02:00Z', finishedAt: '2026-04-09T10:03:07Z', runner: 'gitlab-runner-02', logExcerpt: `$ npm test\n> web-platform@2.0.0 test\n> vitest run\n✓ src/auth/auth.test.ts (12 tests)\n✓ src/components/Button.test.tsx (8 tests)\n✓ src/utils/helpers.test.ts (15 tests)\nTest Files: 3 passed (3)\nTests: 35 passed (35)\nJob succeeded` },
    { id: 'j3', pipelineId: 'pipe1', projectId: 'p1', name: 'test:e2e', stage: 'test', status: 'passed', duration: 89, startedAt: '2026-04-09T10:02:00Z', finishedAt: '2026-04-09T10:03:29Z', runner: 'gitlab-runner-03', logExcerpt: `$ npx playwright test\nRunning 24 tests using 4 workers\n  24 passed (1m 29s)\nJob succeeded` },
    { id: 'j4', pipelineId: 'pipe1', projectId: 'p1', name: 'deploy:production', stage: 'deploy', status: 'passed', duration: 30, startedAt: '2026-04-09T10:04:00Z', finishedAt: '2026-04-09T10:04:30Z', runner: 'gitlab-runner-01', logExcerpt: `$ ./deploy.sh production\nDeploying to production...\nBuilding Docker image...\nPushing to registry...\nUpdating Kubernetes deployment...\nDeployment successful!\nJob succeeded` },
    { id: 'j5', pipelineId: 'pipe2', projectId: 'p1', name: 'build:webpack', stage: 'build', status: 'passed', duration: 42, startedAt: '2026-04-09T15:01:00Z', finishedAt: '2026-04-09T15:01:42Z', runner: 'gitlab-runner-01', logExcerpt: `$ npm run build\n✓ built in 7.8s\nJob succeeded` },
    { id: 'j6', pipelineId: 'pipe2', projectId: 'p1', name: 'test:unit', stage: 'test', status: 'passed', duration: 56, startedAt: '2026-04-09T15:02:00Z', finishedAt: '2026-04-09T15:02:56Z', runner: 'gitlab-runner-02', logExcerpt: `$ npm test\nTests: 35 passed (35)\nJob succeeded` },
    { id: 'j7', pipelineId: 'pipe2', projectId: 'p1', name: 'test:lint', stage: 'test', status: 'passed', duration: 15, startedAt: '2026-04-09T15:02:00Z', finishedAt: '2026-04-09T15:02:15Z', runner: 'gitlab-runner-03', logExcerpt: `$ npm run lint\nNo linting errors found.\nJob succeeded` },
    { id: 'j8', pipelineId: 'pipe3', projectId: 'p1', name: 'build:docs', stage: 'build', status: 'passed', duration: 45, startedAt: '2026-04-09T11:01:00Z', finishedAt: '2026-04-09T11:01:45Z', runner: 'gitlab-runner-01', logExcerpt: `$ npm run build\n✓ built in 2.1s\nJob succeeded` },
    { id: 'j9', pipelineId: 'pipe4', projectId: 'p1', name: 'build:webpack', stage: 'build', status: 'passed', duration: 44, startedAt: '2026-04-09T17:01:00Z', finishedAt: '2026-04-09T17:01:44Z', runner: 'gitlab-runner-01', logExcerpt: `$ npm run build\n✓ built in 8.1s\nJob succeeded` },
    { id: 'j10', pipelineId: 'pipe4', projectId: 'p1', name: 'test:unit', stage: 'test', status: 'running', duration: null, startedAt: '2026-04-09T17:02:00Z', finishedAt: null, runner: 'gitlab-runner-02', logExcerpt: `$ npm test\nRunning tests...\n✓ src/auth/auth.test.ts (12 tests)` },
    ...
    { id: 'j12', pipelineId: 'pipe5', projectId: 'p1', name: 'build:webpack', stage: 'build', status: 'passed', duration: 41, startedAt: '2026-04-09T10:31:00Z', finishedAt: '2026-04-09T10:31:41Z', runner: 'gitlab-runner-01', logExcerpt: `$ npm run build\n✓ built in 7.9s\nJob succeeded` },
    { id: 'j13', pipelineId: 'pipe5', projectId: 'p1', name: 'test:lint', stage: 'test', status: 'failed', duration: 12, startedAt: '2026-04-09T10:32:00Z', finishedAt: '2026-04-09T10:32:12Z', runner: 'gitlab-runner-02', logExcerpt: `$ npm run lint\nERROR: src/pages/Settings.css: Expected semicolon at line 42\nERROR: 1 problem (1 error, 0 warnings)\nJob failed: exit code 1` },
    { id: 'j14', pipelineId: 'pipe6', projectId: 'p1', name: 'build:webpack', stage: 'build', status: 'passed', duration: 43, startedAt: '2026-04-08T09:01:00Z', finishedAt: '2026-04-08T09:01:43Z', runner: 'gitlab-runner-01', logExcerpt: `$ npm run build\n✓ built in 8.0s\nJob succeeded` },
    { id: 'j15', pipelineId: 'pipe6', projectId: 'p1', name: 'test:unit', stage: 'test', status: 'passed', duration: 65, startedAt: '2026-04-08T09:02:00Z', finishedAt: '2026-04-08T09:03:05Z', runner: 'gitlab-runner-02', logExcerpt: `$ npm test\nTests: 35 passed (35)\nJob succeeded` },
    { id: 'j16', pipelineId: 'pipe6', projectId: 'p1', name: 'test:e2e', stage: 'test', status: 'passed', duration: 87, startedAt: '2026-04-08T09:02:00Z', finishedAt: '2026-04-08T09:03:27Z', runner: 'gitlab-runner-03', logExcerpt: `$ npx playwright test\n24 passed\nJob succeeded` },
    { id: 'j17', pipelineId: 'pipe6', projectId: 'p1', name: 'deploy:production', stage: 'deploy', status: 'passed', duration: 28, startedAt: '2026-04-08T09:04:00Z', finishedAt: '2026-04-08T09:04:28Z', runner: 'gitlab-runner-01', logExcerpt: `$ ./deploy.sh production\nDeployment successful!\nJob succeeded` },
    { id: 'j18', pipelineId: 'pipe7', projectId: 'p1', name: 'build:webpack', stage: 'build', status: 'canceled', duration: 30, startedAt: '2026-04-07T14:01:00Z', finishedAt: '2026-04-07T14:01:30Z', runner: 'gitlab-runner-01', logExcerpt: `$ npm run build\nJob was canceled` },
    { id: 'j19', pipelineId: 'pipe8', projectId: 'p1', name: 'build:webpack', stage: 'build', status: 'passed', duration: 46, startedAt: '2026-04-06T11:01:00Z', finishedAt: '2026-04-06T11:01:46Z', runner: 'gitlab-runner-01', logExcerpt: `$ npm run build\n✓ built in 8.2s\nJob succeeded` },
    { id: 'j20', pipelineId: 'pipe8', projectId: 'p1', name: 'test:unit', stage: 'test', status: 'passed', duration: 68, startedAt: '2026-04-06T11:02:00Z', finishedAt: '2026-04-06T11:03:08Z', runner: 'gitlab-runner-02', logExcerpt: `$ npm test\nTests: 35 passed (35)\nJob succeeded` },
    { id: 'j21', pipelineId: 'pipe8', projectId: 'p1', name: 'test:e2e', stage: 'test', status: 'passed', duration: 90, startedAt: '2026-04-06T11:02:00Z', finishedAt: '2026-04-06T11:03:30Z', runner: 'gitlab-runner-03', logExcerpt: `$ npx playwright test\n24 passed\nJob succeeded` },
    { id: 'j22', pipelineId: 'pipe8', projectId: 'p1', name: 'deploy:production', stage: 'deploy', status: 'passed', duration: 29, startedAt: '2026-04-06T11:04:00Z', finishedAt: '2026-04-06T11:04:29Z', runner: 'gitlab-runner-01', logExcerpt: `$ ./deploy.sh production\nDeployment successful!\nJob succeeded` },
  ];

      ...
      return (
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-github-card border border-github-border rounded-md p-8 text-center">
            <Shield size={48} className="mx-auto mb-4 text-github-muted opacity-50" />
            <h3 className="text-lg font-semibold text-white mb-2">Security overview</h3>
            <p className="text-github-muted mb-4 max-w-md mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto mt-6">
              <div className="bg-[#161b22] border border-github-border rounded-md p-4">
                ...
                <div className="text-xs text-github-muted">Dependabot alerts</div>
              </div>
              <div className="bg-[#161b22] border border-github-border rounded-md p-4">
                <div className="text-2xl font-bold text-green-500 mb-1">0</div>
                <div className="text-xs text-github-muted">Code scanning alerts</div>
              </div>
            </div>
          </div>
        </div>

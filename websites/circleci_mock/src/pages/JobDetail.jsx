...
<body><h1>CircleCI Artifact</h1><p>${path}</p><p>Generated by the local sandbox.</p></body></html>`;
  }
  ...
  if (path.endsWith('.js')) return 'console.log("CircleCI sandbox artifact");\n';
  return `CircleCI sandbox artifact\nPath: ${path}\nSize: ${artifact.size} bytes\n`;
}

...
export const createInitialData = () => {
  ...
  const containers = [
    ...
    { id: 'ctn-10', name: 'datadog-agent', image: 'datadog/agent:7.52.1', status: 'running', host: 'web-prod-us-east-1a', cpu: 3.1, memory: 128, memoryLimit: 256, uptime: '7d 2h', restarts: 0, ports: '8125:8125/udp', network: 'host', tags: ['env:production'] },
  ...
  const events = [
    ...
    { id: 'evt-6', title: 'Alert triggered: High CPU on api-prod-us-east-1b', text: 'CPU usage exceeded 90% threshold. Current value: 91.3%', type: 'alert', source: 'datadog', timestamp: isoAgo(30), tags: ['env:production', 'host:api-prod-us-east-1b'], priority: 'normal' },
    { id: 'evt-7', title: 'Alert triggered: Elevated Error Rate on payment-service', text: 'Error rate exceeded 5% threshold. Current value: 5.8%', type: 'alert', source: 'datadog', timestamp: isoAgo(45), tags: ['env:production', 'service:payment-service'], priority: 'normal' },
    { id: 'evt-8', title: 'Alert resolved: Network spike on web-prod-us-east-1a', text: 'Network traffic returned to normal levels', type: 'alert', source: 'datadog', timestamp: hoursAgo(2), tags: ['env:production', 'host:web-prod-us-east-1a'], priority: 'normal' },
    { id: 'evt-9', title: 'Alert triggered: P95 Latency elevated on web-store', text: 'P95 latency exceeded 200ms. Current value: 245ms', type: 'alert', source: 'datadog', timestamp: hoursAgo(2), tags: ['env:production', 'service:web-store'], priority: 'normal' },
    { id: 'evt-10', title: 'Alert resolved: Disk usage on db-prod normalized', text: 'Disk cleanup completed. Usage dropped from 82% to 71%', type: 'alert', source: 'datadog', timestamp: hoursAgo(5), tags: ['env:production', 'host:db-prod-us-east-1a'], priority: 'normal' },
    { id: 'evt-11', title: 'Alert resolved: Memory pressure on cache hosts', text: 'Redis memory usage returned below 75% after eviction policy triggered', type: 'alert', source: 'datadog', timestamp: hoursAgo(10), tags: ['env:production', 'service:redis-cache'], priority: 'normal' },
    ...
    { id: 'evt-16', title: 'New monitor created: Worker queue depth', text: 'Sarah Chen created a new metric monitor for analytics worker queue', type: 'info', source: 'datadog', timestamp: hoursAgo(18), tags: ['env:production', 'service:analytics-worker'], priority: 'low' },
    ...
    { id: 'evt-20', title: 'Agent upgraded on staging-web-1', text: 'Datadog Agent upgraded from 7.51.0 to 7.52.1', type: 'info', source: 'datadog', timestamp: hoursAgo(22), tags: ['env:staging', 'host:staging-web-1'], priority: 'low' },
  ];
  ...
  const incidents = [
    {
      ...
      timeline: [
        { time: hoursAgo(2), author: 'Datadog', text: 'Monitor "Elevated Error Rate on payment-service" triggered at 5.8%' },
    ...
    },
    {
      ...
      timeline: [
        { time: isoAgo(45), author: 'Datadog', text: 'Monitor "High CPU on api-prod-us-east-1b" triggered at 91.3%' },
    ...
    },
    {
      ...
      timeline: [
        { time: hoursAgo(8), author: 'Datadog', text: 'Monitor "Disk usage above 80% on db-prod" triggered at 82%' },
    ...
    },
    {
      ...
      timeline: [
        { time: daysAgo(7), author: 'Datadog', text: 'Consumer lag alert: analytics-consumers group lag at 50,000+ messages.' },
